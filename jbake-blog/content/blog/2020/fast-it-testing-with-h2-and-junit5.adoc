...
image::/img/blog/2020/fast-it-testing-with-h2-and-junit5/h2-load-test-time.png[width=50%, height=50%, Run three empty test loading an H2 db]
...
image::/img/blog/2020/fast-it-testing-with-h2-and-junit5/h2-sequences-query.png[width=50%, height=50%, ]
